...
public class PizzaOrder
{
	public static void main (String [] args)
	{
      ...
      String tax_S;                 // String version of variable tax
      String total_S;               // String version of variable total
      double total = 0;             // total = cost + tax
      ...
      if (inches == 10) {
         ...
         System.out.println("That is not an option, so your pizza will be 12 inches.");
         cost = 12.99;
         inches = 12;
      }
      ...
      switch (crustType) {
         ...
         case 'd':
            ...
            break;
         default:
            System.out.println("That is not a choice. Your pizza will be hand-tossed");
            crust = "Hand-tossed";
            break;
      }
      ...
      if (discount) {
		...
		tax = cost * TAX_RATE;
      tax_S = formatter.format(tax);
      tax = new Double(tax_S);
      total = cost + tax;
      total_S = formatter.format(total);
      total = new Double(total_S);
